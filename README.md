...
To run the code, you can directly run the notebook : **2_Compute_the_results** ! 

### 1: ROUGE 

ROUGE, also called **Recall-Oriented Understudy for Gisting Evaluation** is a metric designed to measure the quality of **summaries** by comparing them to **human reference summaries**. ROUGE contains multiple metrics, the one we decided to use is ROUGE-N, which measures the **overlap of N-grams between the LLM-generated summary and the reference summary** - in other words, it looks for the longest common subsequence of N-grams between the reference and the summarized text. Compared to rouge-1 or rouge-2 it captures more the sentence structure more accurately.
...
In this section, we analyzed the performance metrics of various AI models. The results are visually represented in a heatmap, which allows us to quickly grasp the comparative strengths and weaknesses of each model across different metrics.

The heatmap below provides a detailed overview, showing how each model scores on specific performance criteria. This visualization is an efficient way to identify which models excel in particular areas and which may require improvements.

<div style="display: flex; justify-content: center;">
    <img height="100%" width="450px" src="./read_me_img/final_results.png" alt="Heatmap displaying the scores of each model across various metrics.">
</div>

Following the heatmap analysis, we computed the best and worst scores for each metric to pinpoint the top and bottom-performing models. From this computation, "ChatGPT" emerged as the best-performing model, while "Mistral" showed up as the worst in certain metrics. These findings are illustrated in the bar charts below, which highlight the highest and lowest scores, providing a clear visual distinction between the best and worst model performances.

<div style="display: flex; justify-content: center;">
    <img height="100%" width="450px" src="./read_me_img/best_scores.png" alt="Bar chart showing the best scores achieved by models across various metrics.">
</div>

<br></br>

<div style="display: flex; justify-content: center;">
    <img height="100%" width="450px" src="./read_me_img/worse_scores.png" alt="Bar chart displaying the worst scores by models across various metrics.">
</div>

These visualizations not only highlight the capabilities and limitations of the models but also guide further development and optimization efforts.

Finally, from a study we found the following ranking, to compare our findings to other findings and metrics: 

<div style="display: flex; justify-content: center;">
    <img height="100%" width="450px" src="./read_me_img/study_img.png" alt="Bar chart displaying the worst scores by models across various metrics.">
</div>
<br/>
<div style="display: flex; justify-content: center;">
    <img height="100%" width="450px" src="./read_me_img/study_img2.png" alt="Bar chart displaying the worst scores by models across various metrics.">
</div>